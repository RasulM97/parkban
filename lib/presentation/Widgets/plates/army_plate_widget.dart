...
class ArmyPlate extends StatefulWidget {
  ArmyPlate({required this.width, this.num1, this.num2, this.letter, this.letters, this.num3, this.autofocus = false, this.enable = false, Key? key})
      : super(key: key);
          ...
          children: [
            ...
            Expanded(
              ...
              child: TextField(
                ...
                style:
                    const TextStyle(fontFamily: 'BTitr',color: Colors.black, fontSize: 38, fontWeight: FontWeight.bold),
