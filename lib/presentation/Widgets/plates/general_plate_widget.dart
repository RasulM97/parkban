          ...
          children: [
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .bodyText1!
                          .copyWith(fontSize: widget.width * 0.028, color: Colors.white, fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
              ),
            ...
            Expanded(
              ...
              child: PopupMenuButton(
                ...
                icon: Text(
                  letter,
                  style: TextStyle(fontFamily: 'BTitr',color: Colors.black, fontSize: widget.width * 0.07, fontWeight: FontWeight.bold),
                ),
                initialValue: letter,
                onSelected: (value) {
                  setState(() {
