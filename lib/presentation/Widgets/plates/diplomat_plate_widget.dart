...
class DiplomatPlate extends StatefulWidget {
  DiplomatPlate({
    required this.width,
    this.num1,
    this.num2,
  ...
  static const String id = 'سياسي يا ديپلمات جديد';

  @override
  State<DiplomatPlate> createState() => DiplomatPlateState();
}

class DiplomatPlateState extends State<DiplomatPlate> {
          ...
          children: [
            ...
            Expanded(
              ...
              child: TextField(
                ...
                style:
                TextStyle(fontFamily: 'BTitr',color: Colors.black, fontSize: 38, fontWeight: FontWeight.bold),
              ...
              child: PopupMenuButton(
                ...
                icon: Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .bodyText1!
                      .copyWith(fontFamily: 'BTitr',color: Colors.black, fontSize: widget.width * 0.07, fontWeight: FontWeight.bold),
                ),
                initialValue: letter,
                onSelected: (value) {
                  setState(() {
                  ...
                  return (widget.letters != null)
                      ...
                      child: Center(
                        child: Text(
                          char,
                          textScaleFactor: 1.2,
                          style: TextStyle(fontFamily: 'BTitr',fontSize: widget.width * 0.05 /*isTablet ? 18 : 14*/, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                  )
            ...
            Expanded(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(border: Border(left: BorderSide(color: Colors.black, width: 2))),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Image.asset('assets/images/siac_black.png', width: double.infinity,fit: BoxFit.fitWidth,),
                      ),
                      Transform.translate(
                        ...
                        child: TextField(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .bodyText1!
                              .copyWith(fontFamily: 'BTitr',color: Colors.black, fontSize: 38, fontWeight: FontWeight.bold),
                          decoration: const InputDecoration(
                            filled: true,
                            fillColor: Colors.transparent,
                            counterText: '',
