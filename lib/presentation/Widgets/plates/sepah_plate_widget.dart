...
class SepahPlate extends StatefulWidget {
  SepahPlate({
    required this.width,
    this.num1,
    this.num2,
  ...
  static const String id = 'سپاه';

  @override
  State<SepahPlate> createState() => SepahPlateState();
}

class SepahPlateState extends State<SepahPlate> {
  ...
  String letter = 'ث';
  List<String> letters = ['ث'];

  @override
  void initState() {
    super.initState();

    letter = widget.letter ?? 'ث';
    letters = widget.letters ?? ['ث'];
