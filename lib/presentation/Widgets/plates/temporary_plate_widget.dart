...
class TemporaryPlateState extends State<TemporaryPlate> {
  ...
  Widget build(BuildContext context) {
    ...
    num4Controller.addListener(() {
      if (num4Controller.value.text.trim().length == 2 && !num4Controller.text.contains('/')) {
                  ...
                  children: [
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .bodyText1!
                          .copyWith(color: Colors.white, fontSize: widget.width * 0.048, fontWeight: FontWeight.bold),
                    ),
                    Text(
                      'I.R.\nIRAN',
                      style: TextStyle(
                  ...
                  children: [
                    Expanded(
                      ...
                      child: TextField(
                        ...
                        maxLength: 2,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontFamily: 'BTitr', color: Colors.black, fontSize: widget.width * 0.05, fontWeight: FontWeight.bold),
                        decoration: const InputDecoration(
                          contentPadding: EdgeInsets.all(1),
                          filled: true,
                          fillColor: Colors.transparent,
