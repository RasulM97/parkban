...
class DefencePlate extends StatefulWidget {
  DefencePlate({
    required this.width,
    this.num1,
    this.num2,
  ...
  static const String id = 'وزارت دفاع';

  @override
  State<DefencePlate> createState() => DefencePlateState();
}

class DefencePlateState extends State<DefencePlate> {
