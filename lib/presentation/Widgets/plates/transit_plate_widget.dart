...
class TransitPlate extends StatefulWidget {
  TransitPlate(
      {required this.width, this.num1, this.num2, this.letter, this.letters, this.num3, this.autofocus = false, this.enable = false, Key? key})
      : super(key: key);
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage('assets/images/plate_transit_side.jpg'),
                          fit: BoxFit.fill,
                        ),
                                        ...
                                        child: Center(
                                          child: Text(
                                            ...
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyText1!
                                                .copyWith(fontFamily: 'BTitr',color: Colors.black, fontSize: widget.width * 0.05 /*isTablet ? 18 : 14*/, fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                      ),
                                    )
              ...
              child: Container(
                ...
                child: FittedBox(
                  child: Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: widget.width * 0.03, color: Colors.white),
                  ),
                ),
              ),
            )
