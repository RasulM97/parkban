...
class ProtocolPlate extends StatefulWidget {
  ProtocolPlate({required this.width, this.num, this.autofocus = false, this.enable = false, Key? key}) : super(key: key);
                  ...
                  children: [
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .bodyText1!
                          .copyWith(color: Colors.white, fontSize: widget.width * 0.045, fontWeight: FontWeight.bold),
                    ),
                    Text(
                      'I.R.\nIRAN',
                      style: Theme.of(context)
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .bodyText1!
                      .copyWith(fontFamily: 'BTitr',color: Colors.white, fontSize: widget.width * 0.05, fontWeight: FontWeight.bold),
                ),
                Text(
                  'PROTOCOL',
                  style: Theme.of(context)
                      .textTheme
                      .bodyText1!
                      .copyWith(color: Colors.white, fontSize: widget.width * 0.05, fontWeight: FontWeight.bold),
                ),
              ]),
            ),
            Expanded(
